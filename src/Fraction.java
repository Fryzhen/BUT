...
public class Fraction {
	...
	*/
    ...
    public Fraction additionner(Fraction a) {
        Fraction frac = new Fraction(this.numerateur * a.denominateur + this.denominateur * a.numerateur , this.denominateur * a.denominateur);
        return frac;
    }

    public Fraction multiplier(Fraction a, Fraction b) {
        Fraction frac = new Fraction(this.numerateur * a.numerateur , this.denominateur * a.denominateur);
        return frac;
    }
